...
describe("parseSpeaker", () => {
  ...
  it("町長（名前君）パターンを解析する", () => {
    const result = parseSpeaker("○町長（山田花子君）　お答えいたします。");
  ...
  it("副町長パターンを解析する", () => {
    const result = parseSpeaker("○副町長（鈴木一郎君）　ご説明いたします。");
  ...
  it("教育長パターンを解析する", () => {
    const result = parseSpeaker("○教育長（高橋三郎君）　お答えいたします。");
  ...
  it("名前に空白を含む場合は除去される", () => {
    const result = parseSpeaker("○町長（山田　花子君）　答弁します。");
    expect(result.speakerName).toBe("山田花子");
  });
