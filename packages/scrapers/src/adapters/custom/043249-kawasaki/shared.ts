/**
 * 川崎町議会（宮城県）会議録 — 共通ユーティリティ
 *
 * サイト: https://www.town.kawasaki.miyagi.jp/site/gikai/
 * 自治体コード: 043249
 *
 * 令和3年以降は PDF 公開、令和2年以前は HTML 直接公開の混在形式。
 */

export const BASE_ORIGIN = "https://www.town.kawasaki.miyagi.jp";
export const LIST_PAGE_URL = `${BASE_ORIGIN}/site/gikai/list6-25.html`;
