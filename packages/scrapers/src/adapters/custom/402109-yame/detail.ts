...
import type { YameMeeting } from "./list";
 ...
 *   ○３番（氏名）     → role=議員, name=氏名
 *   ○臨時議長（氏名） → role=議長, name=氏名
 *   ○議会事務局長（氏名） → role=議会事務局長, name=氏名
 */
