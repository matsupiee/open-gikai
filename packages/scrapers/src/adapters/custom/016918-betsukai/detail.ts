 ...
 *
 * 対応パターン:
 *   ○議長（田村秀策君）　→ role=議長, name=田村秀策
 *   ○町長（奥山盛君）　→ role=町長, name=奥山盛
 *   ○５番（渡邊勝美君）→ role=議員, name=渡邊勝美
 */
...
async function fetchPdfText(pdfUrl: string): Promise<string | null> {
  try {
    ...
    console.warn(
      `[016918-betsukai] PDF 取得失敗: ${pdfUrl}`,
