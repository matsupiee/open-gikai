...
export const BASE_ORIGIN = "https://www.town.shimane-kawamoto.lg.jp";
export const TOP_PAGE_URL = `${BASE_ORIGIN}/gyosei/town_administration/kawamoto_council/kaigiroku/`;
 ...
 * パターン: "令和7年3月7日：初日" / "平成30年3月20日：最終日"
 * 解析できない場合は null を返す。
 */
