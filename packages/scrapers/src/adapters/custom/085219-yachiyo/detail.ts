...
import type { YachiyoMeeting } from "./list";
 ...
 *   ○町長（鈴木花子君）　→ role=町長, name=鈴木花子
 *   ○3番（田中一郎君）→ role=議員, name=田中一郎
...
async function fetchPdfText(pdfUrl: string): Promise<string | null> {
  try {
    ...
    console.warn(
      `[085219-yachiyo] PDF 取得失敗: ${pdfUrl}`,
 ...
 * e.g., "/data/doc/1745820928_doc_62_0.pdf" → "1745820928_doc_62_0"
 */
