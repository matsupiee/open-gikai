...
export interface NagayoDetailParams {
  title: string;
  pdfUrl: string;
  meetingType: string;
  headingYear: number;
 ...
 * heldOn の取得に失敗した場合も null を返す。
 */
export async function buildMeetingData(
  params: NagayoDetailParams,
  ...
  return {
    ...
    externalId: `nagayo_${params.heldOn}_${params.title}`,
    statements,
  };
}
