...
export const BASE_ORIGIN = "https://www.town.kusatsu.gunma.jp";

/** 会議録一覧ページのパス */
export const LIST_PAGE_PATH =
  "/www/contents/1654156951891/index.html";
...
export async function fetchPage(url: string): Promise<string | null> {
  try {
    ...
    console.warn(`[104264-kusatsu] fetchPage failed: ${url}`, e);
    return null;
  }
}
...
export async function fetchBinary(url: string): Promise<ArrayBuffer | null> {
  try {
    ...
    console.warn(`[104264-kusatsu] fetchBinary failed: ${url}`, e);
    return null;
  }
}
