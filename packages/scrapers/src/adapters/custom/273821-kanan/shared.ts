 ...
 * PDF ベースの議事録公開。定例会議・臨時会議・予算決算常任委員会が掲載。
 */

export const BASE_ORIGIN = "https://www.town.kanan.osaka.jp";

/** 会議録トップページのパス */
export const TOP_PAGE_PATH = "/gyoseijoho/gikai/1/index.html";

/** 予算・決算常任委員会インデックスページ ID */
export const BUDGET_PAGE_IDS: Record<number, string> = {
  2024: "7713",
  2023: "7147",
};
