/**
 * 座間味村議会 会議録 — 共通ユーティリティ
 *
 * サイト: https://www.vill.zamami.okinawa.jp/info/kaigiroku.html
 * 自治体コード: 473545
 *
 * 全会議録は単一HTMLページにPDFリンクとして掲載されている。
 */

export const BASE_ORIGIN = "https://www.vill.zamami.okinawa.jp";
export const LIST_URL = `${BASE_ORIGIN}/info/kaigiroku.html`;
