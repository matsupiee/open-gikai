/**
 * 池田町議会（長野県北安曇郡） — 共通ユーティリティ
 *
 * サイト: https://www.ikedamachi.net/0000000115.html
 * PDF ベースの議事録公開。全年度が単一ページに集約されている。
 */

export const BASE_ORIGIN = "https://www.ikedamachi.net";

export const LIST_URL = "https://www.ikedamachi.net/0000000115.html";
...
/**
 * 和暦テキストから西暦年を返す。
 * e.g., "令和7" → 2025, "平成30" → 2018, "令和元" → 2019
 */
