...
export interface KoumiDetailParams {
  title: string;
  year: number;
  pdfUrl: string;
  meetingType: string;
 ...
 * 例: "令和７年６月１０日" → "2025-06-10"
 * 例: "平成２５年３月１日" → "2013-03-01"
 *
...
export async function buildMeetingData(
  ...
  return {
    ...
    externalId: `koumi_${params.sessionKey}`,
    statements,
  };
}
