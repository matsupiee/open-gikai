...
export interface TaijiDetailParams {
  title: string;
  heldOn: string | null;
  pdfUrl: string;
  meetingType: string;
...
export async function buildMeetingData(
  ...
  const fileBaseName = params.fileName.replace(/\.(pdf|docx)$/i, "");
  ...
  return {
    ...
    externalId: `taiji_${fileBaseName}`,
    statements,
  };
}
