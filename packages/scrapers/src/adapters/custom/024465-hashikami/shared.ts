 ...
 * ColdFusion CMS 上の単一ページに全会議録 PDF リンクを掲載。
 */

export const BASE_ORIGIN = "https://www.town.hashikami.lg.jp";

/** 会議録一覧ページの固定 URL（ColdFusion CMS のカンマ入り URL） */
export const LIST_URL =
  "https://www.town.hashikami.lg.jp/index.cfm/9,0,46,438,html";
