...
export const BASE_ORIGIN = "https://www.shichigahama.com";
...
export async function fetchPage(url: string): Promise<string | null> {
  try {
    ...
    console.warn(`[044041-shichigahama] fetchPage failed: ${url}`, e);
    return null;
  }
}
...
export async function fetchBinary(url: string): Promise<ArrayBuffer | null> {
  try {
    ...
    console.warn(`[044041-shichigahama] fetchBinary failed: ${url}`, e);
    return null;
  }
}
