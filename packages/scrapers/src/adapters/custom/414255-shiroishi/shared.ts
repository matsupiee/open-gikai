...
export const BASE_ORIGIN = "https://www.town.shiroishi.lg.jp";
export const TOP_PAGE_URL = `${BASE_ORIGIN}/chousei_machi/gikai/kaigiroku.html`;
...
/**
 * 和暦テキストから西暦年を抽出する。
 * 例: "令和6年9月 定例会" → 2024, "平成30年12月 定例会" → 2018
 */
