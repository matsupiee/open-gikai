...
export const BASE_ORIGIN = "https://www.town.tateshina.nagano.jp";

/** 会議録トップページの URL */
export const KAIGIROKU_TOP_URL =
  "https://www.town.tateshina.nagano.jp/gyoseijoho/gikai/kaigiroku/index.html";
