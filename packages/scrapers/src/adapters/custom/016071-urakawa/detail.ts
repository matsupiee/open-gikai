...
import type { UrakawaMeeting } from "./list";
import { detectMeetingType, fetchBinary, toHalfWidth } from "./shared";
...
async function fetchPdfText(pdfUrl: string): Promise<string | null> {
  try {
    ...
    console.warn(
      `[016071-urakawa] PDF 取得失敗: ${pdfUrl}`,
