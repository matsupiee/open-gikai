...
export interface MisawaDetailParams {
  title: string;
  heldOn: string | null;
 ...
 * e.g., "/index.cfm/24,11423,c,html/11423/20250301-120000.pdf" → "20250301-120000"
 */
...
export async function fetchMeetingData(
  ...
  const externalId = idKey ? `misawa_${idKey}` : null;
