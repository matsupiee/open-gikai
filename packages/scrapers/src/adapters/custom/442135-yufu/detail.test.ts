...
describe("parseSpeaker", () => {
  ...
  it("副市長を正しくパースする", () => {
    const result = parseSpeaker("○副市長（中村四郎君）　ご説明します。");
  ...
  it("副議長を正しくパースする", () => {
    const result = parseSpeaker("○副議長（松田六郎君）　ご説明します。");
    expect(result.speakerName).toBe("松田六郎");
