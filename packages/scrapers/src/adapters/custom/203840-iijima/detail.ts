...
import type { IijimaMeeting } from "./list";
 ...
 * e.g., "https://www.town.iijima.lg.jp/material/files/group/10/R7_3_gikaiteireikai.pdf"
 *   → "R7_3_gikaiteireikai"
 */
...
export async function fetchMeetingData(
  ...
  const externalId = idKey ? `iijima_${idKey}` : null;
