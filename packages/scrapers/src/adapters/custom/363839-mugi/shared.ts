...
export const BASE_ORIGIN = "https://www.town.tokushima-mugi.lg.jp";
 ...
 * 全角数字を半角数字に変換する。
 */
export function toHankakuDigits(text: string): string {
 ...
 * 和暦の年表記から西暦を返す。
 * 全角・半角数字の両方に対応。
 * 例: "令和7年" -> 2025, "令和７年" -> 2025, "令和元年" -> 2019
 */
export function parseWarekiYear(text: string): number | null {
  const normalized = toHankakuDigits(text);
