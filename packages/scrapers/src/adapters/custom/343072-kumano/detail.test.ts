...
describe("buildMeetingData", () => {
    ...
    const result = buildMeetingData(
      {
        title: "令和6年予算特別委員会",
        heldOn: "2024-01-01",
        pdfUrl: "https://www.town.kumano.hiroshima.jp/www/contents/1710119246226/files/reiwa6yotokumokuji.pdf",
  ...
  it("externalId が pdfUrl を含む", () => {
    const pdfUrl =
      "https://www.town.kumano.hiroshima.jp/www/contents/1710119246226/files/test.pdf";
    const result = buildMeetingData(
      {
        title: "令和6年第1回熊野町議会定例会（3月5日）",
        heldOn: "2024-03-05",
    ...
    expect(result!.externalId).toContain("kumano_");
  });
});
