...
describe("parseSpeaker", () => {
  it("議長（名前）パターンを解析する", () => {
    const result = parseSpeaker("○議長（田中一郎）　ただいまから本日の会議を開きます。");
  ...
  it("町長（名前）パターンを解析する", () => {
    const result = parseSpeaker("○町長（山田太郎）　お答えいたします。");
  ...
  it("副町長（名前）パターンを解析する", () => {
    const result = parseSpeaker("○副町長（佐藤次郎）　御説明申し上げます。");
  ...
  it("教育長（名前）パターンを解析する", () => {
    const result = parseSpeaker("○教育長（中村三郎）　お答えいたします。");
  ...
  it("番号議員（半角）パターンを解析する", () => {
    const result = parseSpeaker("○3番（鈴木花子）　質問いたします。");
  ...
  it("番号議員（全角）パターンを解析する", () => {
    const result = parseSpeaker("○３番（田中太郎）　発言します。");
  ...
  it("議会運営委員長パターンを解析する", () => {
    const result = parseSpeaker("○議会運営委員長（鈴木一郎）　ただいまから委員会を開会します。");
  ...
  it("副議長（名前）パターンを解析する", () => {
    const result = parseSpeaker("○副議長（高橋四郎）　暫時休憩します。");
