...
export const BASE_ORIGIN = "https://www.town.shakotan.lg.jp";
export const TOP_PAGE_PATH = "/contents/content0730.html";
...
/**
 * 和暦の年見出しから西暦年を返す。
 * 「令和7年」→ 2025, 「令和元年」→ 2019, 「平成31年」→ 2019
 * 全角数字にも対応する。
 */
