...
export interface MasakiDetailParams {
  title: string;
  heldOn: string | null;
  pdfUrl: string;
  meetingType: string;
...
export async function buildMeetingData(
  ...
  return {
    ...
    externalId: `masaki_${params.meetingPageId}_${params.pdfUrl.split("/").pop()}`,
    statements,
  };
}
