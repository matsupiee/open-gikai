...
describe("parseSpeaker", () => {
  ...
  it("市長を正しくパースする", () => {
    const result = parseSpeaker("○市長（山田一郎君）　お答えいたします。");
  ...
  it("副市長を正しくパースする", () => {
    const result = parseSpeaker("○副市長（鈴木二郎君）　ご説明いたします。");
  ...
  it("教育長を正しくパースする", () => {
    const result = parseSpeaker("○教育長（佐藤三郎君）　ご説明申し上げます。");
  ...
  it("番号付き議員を正しくパースする", () => {
    const result = parseSpeaker("○３番（伊藤四郎君）　質問いたします。");
  ...
  it("課長を正しくパースする", () => {
    const result = parseSpeaker("○建設課長（高橋五郎君）　ご報告いたします。");
  ...
  it("副委員長を正しくパースする（委員長より先にマッチ）", () => {
    const result = parseSpeaker("○副委員長（渡辺六郎君）　ご報告申し上げます。");
