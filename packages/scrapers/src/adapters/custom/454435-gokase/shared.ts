...
export const BASE_ORIGIN = "https://www.town.gokase.miyazaki.jp";
export const BASE_PATH = "/kakuka/gikai/honkaigi/kaigiroku";
 ...
 * e.g., "/material/files/group/9/0701kaigiroku.pdf" → "0701kaigiroku"
 */
