...
export interface MinobuDetailParams {
  title: string;
  year: number;
  pdfUrl: string;
  meetingType: string;
...
export async function buildMeetingData(
  ...
  return {
    ...
    externalId: `minobu_${params.year}_${params.title.replace(/\s/g, "_")}`,
    statements,
  };
}
