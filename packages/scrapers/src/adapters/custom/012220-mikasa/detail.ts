...
export interface MikasaDetailParams {
  title: string;
  heldOn: string;
  pdfUrl: string;
  meetingType: string;
 ...
 *   ○市長（鈴木一郎君）　→ role=市長, name=鈴木一郎
 *   ○３番（山田花子君）　→ role=議員, name=山田花子
...
export async function buildMeetingData(
  ...
  return {
    ...
    externalId: `mikasa_${params.heldOn}_${encodeURIComponent(params.title)}`,
    statements,
  };
}
