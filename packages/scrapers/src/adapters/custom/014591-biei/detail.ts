...
import type { BieiMeeting } from "./list";
 ...
 *
 * 対応パターン:
 *   ○議長（野村祐司議員）　→ role=議長, name=野村祐司
 *   ○町長（角和浩幸君）　→ role=町長, name=角和浩幸
 *   ○４番（興梠勝也議員）→ role=議員, name=興梠勝也
 *   ○地域みらい創造室長（谷口雄二君）→ role=室長, name=谷口雄二
 */
