...
describe("parseSpeaker", () => {
  ...
  it("番号付き議員パターンを解析する", () => {
    ...
    expect(result.speakerName).toBe("鈴木孝雄");
  ...
  it("副委員長パターンを解析する", () => {
    ...
    expect(result.speakerName).toBe("田村三郎");
...
`;
    ...
    expect(statements[1]!.speakerName).toBe("鈴木孝雄");
