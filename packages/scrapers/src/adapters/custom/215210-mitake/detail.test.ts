...
describe("parseSpeaker", () => {
  ...
  it("副町長パターンを解析する", () => {
    ...
    expect(result.speakerName).toBe("渡辺次郎");
...
○３番（佐藤三郎君）　質問です。`;
  ...
  it("ト書き（登壇）はスキップする", () => {
    const text = `○議長（鈴木　太郎君）　ただいまから会議を開きます。
（３番　佐藤三郎君登壇）
○３番（佐藤三郎君）　質問があります。`;
