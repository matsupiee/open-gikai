...
export const BASE_ORIGIN = "https://www.town.nagawa.nagano.jp";

/** 会議録一覧ページの URL */
export const LIST_PAGE_URL =
  "https://www.town.nagawa.nagano.jp/gyoseijoho/gikai/teireikai-rinjikai/1/index.html";
 ...
 * 例: "令和６年" → 2024, "令和元年" → 2019, "平成２５年" → 2013
 */
