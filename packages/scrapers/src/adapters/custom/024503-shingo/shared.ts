 ...
 * WordPress ベースの村公式サイト。会議録を PDF ファイルで公開。
 */

export const BASE_ORIGIN = "https://www.vill.shingo.aomori.jp";

/** 会議録一覧ページの固定 URL */
export const LIST_URL = "https://www.vill.shingo.aomori.jp/page-25971/";
