...
import type { MimataMeeting } from "./list";
...
export async function fetchMeetingData(
  ...
  const encodedFilename = urlPath.split("/").pop() ?? null;
  const externalId = encodedFilename
    ? `mimata_${encodedFilename}`
    : null;
