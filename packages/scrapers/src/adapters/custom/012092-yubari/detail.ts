...
export interface YubariDetailParams {
  title: string;
  heldOn: string;
  pdfUrl: string;
  meetingType: string;
...
export async function buildMeetingData(
  ...
  return {
    ...
    externalId: `yubari_${params.heldOn}_${encodeURIComponent(params.title)}`,
    statements,
  };
}
