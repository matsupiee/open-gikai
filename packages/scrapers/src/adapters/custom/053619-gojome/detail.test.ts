...
describe("parseSpeaker", () => {
  ...
  it("副委員長は委員長より先にマッチする", () => {
    ...
    expect(result.speakerName).toBe("佐々木四郎");
...
`;
    ...
    expect(statements[0]!.speakerName).toBe("佐藤太郎");
...
○12番（鈴木花子君）　質問です。`;
  ...
  it("ト書き（登壇）はスキップする", () => {
    const text = `○議長（佐藤太郎君）　ただいまから会議を開きます。
（12番　鈴木花子君登壇）
○12番（鈴木花子君）　質問があります。`;
