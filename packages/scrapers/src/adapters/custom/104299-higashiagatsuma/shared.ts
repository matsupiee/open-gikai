...
export const BASE_ORIGIN = "https://www.town.higashiagatsuma.gunma.jp";
 ...
 * e.g., "/www/gikai/contents/1740031692892/files/teireikai0703.pdf" → "1740031692892_teireikai0703"
 */
export function extractExternalIdKey(pdfPath: string): string | null {
  const match = pdfPath.match(/\/(\d+)\/files\/([^/]+)\.pdf$/i);
