...
export const BASE_ORIGIN = "https://www.town.hyogo-taishi.lg.jp";

/** 年度別インデックスページ（令和元年以降） */
export const INDEX_URL_RECENT = `${BASE_ORIGIN}/soshikikarasagasu/taishityougikai/honkaiginnokaigiroku/index.html`;

/** 年度別インデックスページ（平成28年以前） */
export const INDEX_URL_OLD = `${BASE_ORIGIN}/soshikikarasagasu/taishityougikai/honkaiginnokaigiroku/honkaigikaigiroku/index.html`;
