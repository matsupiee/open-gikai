 ...
 * 議会活動記録 PDF から会議情報を取得する。
 * 会議録本文は PDF のみで提供されているため、PDF ダウンロード → テキスト抽出のパイプラインを使用する。
 */

export const BASE_ORIGIN = "https://www.vill-tenryu.jp";

export const LIST_URL =
  "https://www.vill-tenryu.jp/category/notice/administrative/government_info/parliament/";
