...
// combobox.tsx uses base-ui render prop pattern; cast to bypass radix-ui Button type mismatch
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const InputGroupButton = InputGroupButtonBase as React.ComponentType<any>
